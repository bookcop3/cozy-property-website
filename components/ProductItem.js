...
export default function ProductItem({ product }) {
  return (
    <div>
      <div>
        <div>
          <div className="m-7 shadow p-4 rounded-lg bg-white">
            <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
              <span className="absolute top-10 left-3 inline-flex  px-3 py-2 rounded-lg  bg-green-400 text-sm text-white select-none">
                {product.sales_type}
              </span>
              <button>
                <svg
                  className="absolute top-10 right-2  w-7 h-7  fill-current text-white "
                ...
                <svg
                  className="absolute top-10 right-2 w-7 h-7  fill-current text-red-500 "
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                  ...
                  <span className="mt-2 xl:mt-0">{product.product_type}</span>
                </p>
                <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                  <svg
                    className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
                  ...
                  <span className="mt-2 xl:mt-0">{product.details}</span>
                </p>
                <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                  <svg
                    className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
