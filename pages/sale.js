              ...
              >
                <div className="shadow p-4 rounded-lg bg-white">
                  <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                    ...
                    <svg
                      className="w-7 h-7 fill-current text-red-500"
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-2">รังสิต ปทุมธานี</p>
                  </div>

                  <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                    <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                      >
                      ...
                      <span className="mt-2 xl:mt-0">คอนโดนิเนียม</span>
                    </p>
                    <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
                      ...
                      <span className="mt-2 xl:mt-0">เฟอร์นิเจอร์</span>
                    </p>
                    <p className="inline-flex flex-col xl:flex-row xl:items-center ">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
                      ...
                      <span className="mt-2 xl:mt-0">1,386 ตร.ฟต.</span>
                    </p>
                    <p className="inline-flex flex-col xl:flex-row xl:items-center +">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-green-500"
                      ...
                      <span className="mt-2 xl:mt-0">$1.98 /ตร.ฟต.</span>
                    </p>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                      <span clasNames="text-sm uppercase">$</span>
      ...
      <div className=" p-4 flex items-center flex-wrap">
        <nav aria-label="Page navigation">
          <ul className="inline-flex space-x-2">
            <li>
              <button className="flex items-center justify-center w-10 h-10 text-green-600 transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-green-100">
            ...
            <li>
              <button className="w-10 h-10 text-green-600 transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-green-100">
                1
              </button>
            </li>
            <li>
              <button className="w-10 h-10 text-white transition-colors duration-150 bg-green-600 border border-r-0 border-green-600 rounded-full focus:shadow-outline">
                2
              </button>
            </li>
            <li>
            ...
            <li>
              <button className="flex items-center justify-center w-10 h-10 text-green-600 transition-colors duration-150 bg-white rounded-full focus:shadow-outline hover:bg-green-100">
                <svg classNames="w-4 h-4 fill-current" viewBox="0 0 20 20">
                  <path
